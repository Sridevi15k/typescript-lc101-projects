...
//console.log(` ${spacecraftName} would take ${daysToMars} to get to the Mars.`);
...
// console.log(`${spacecraftName} would take ${getDaysToLocation(kilometersToMars)} to get to the Mars.`);
